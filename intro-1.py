import pygame
import random
from utils import (esta_sobre, cambio_color_boton, actualizar_sonido)

def intro_juego_parrafo():
    """
    ...
    pygame.display.set_caption("Monsters Hunters - Intro")
    ...
    fondo = pygame.image.load("assets/fondos_animados/fondo_menu2.jpg").convert()
    ...
    while mostrando:
        ...
        for coor in coor_lluvia:
            x = coor[0]
            y = coor[1]
            pygame.draw.circle(pantalla, ROJO, (x, y), 1)
            coor[1] += 1
            if coor[1] > 800:
                coor[1] = 0 
